...
def parse_file_contents(file_contents, change_imports=None):
    """
    Convert a pygyat file's contents to python
    """
...
def parse_file(filepath, filename_prefix, outputname=None, change_imports=None):
    ...
    pygyattified = parse_file_contents(infile_str_raw, change_imports=change_imports)

    with open(filename_prefix + _change_file_name(filename, outputname), "w") as outfile:
        outfile.write(pygyattified)
